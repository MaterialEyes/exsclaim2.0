...
build/exsclaim: build/create_directory
	...
	cp -aru exsclaim/*.* exsclaim/alembic exsclaim/api exsclaim/db exsclaim/figures exsclaim/llms exsclaim/journals exsclaim/utilities build/exsclaim/
	cp -aru setup.py pyproject.toml LICENSE README.md MANIFEST.in build
