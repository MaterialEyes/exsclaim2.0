...
__all__ = ["convert_coords_to_labelbox", "convert_labelbox_to_coords", "find_box_center", "is_contained"]
...
def crop_from_labelbox(geometry: list[dict], image: "numpy.ndarray") -> "numpy.ndarray":
