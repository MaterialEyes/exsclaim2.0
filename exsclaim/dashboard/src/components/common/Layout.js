...
import ImagesPage from '../results/ImagesPage.js';
import SearchPage from '../search/SearchPage.js';
import { Box, Grid, Paper, styled } from '@mui/material';
import { fetchArticles, fetchSubFigures, fetchFigures } from '../../services/ApiClient.js';
...
const Layout = (props) => {
	...
	const getSubFigures = async (page) => {
		...
		setSubFigures(oldArray => [...oldArray, ...subFiguresJson]);
		setAllSubFigures(oldArray => [...oldArray, ...subFiguresJson]);
	...
	const getFigures = async (page) => {
		...
		setFigures(oldArray => [...oldArray, ...figuresJson]);
